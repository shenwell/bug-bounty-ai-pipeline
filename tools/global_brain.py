...
Stored at ~/.cursor/pentest-global/ (user-scope, persists across projects).
...
def get_global_brain_dir() -> Path:
    """Global brain lives in user-level Cursor config."""
    return Path(os.environ.get(
        "PENTEST_GLOBAL_BRAIN",
        os.path.expanduser("~/.cursor/pentest-global"),
    ))
