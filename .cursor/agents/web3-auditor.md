...
## MANDATORY: Read when scope includes contracts

If `scope.yaml` lists smart contracts, protocol addresses, or Immunefi/Code4rena scope:

```
skills/hunt-web3/SKILL.md
```

Gate class `web3` — skip with `not-applicable` when no blockchain assets in scope.
