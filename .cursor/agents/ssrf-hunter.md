...
This is the SSRF hunting methodology — cloud metadata chains, blind oracles,
Gopher/redis pivot, open-redirect hops, and escalation boundaries vs
`cloud-misconfig`. DNS-only callback alone is never-submit.
